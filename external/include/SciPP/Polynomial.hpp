...
namespace scp
{
	...
	class Polynomial
	{
		public:
			...
			Polynomial();								///< Default constructor. Init the polynomial to 0.
			Polynomial(int64_t x);						///< Init the polynomial to the constant value `x`.
			Polynomial(const T& x);						///< Init the polynomial to the constant value `x`.
